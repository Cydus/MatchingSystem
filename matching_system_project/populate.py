...
def populate():
    ...
    add_project(title="Fiberoptic infrastructure",
    ...
    add_project(title="Information retrieval research group",
    ...
    add_project(title="Cow Milking Robot 3.0",
    ...
    add_project(title="Rector election app",
    ...
    add_project(title="Automatic Will Smith detection device",
    ...
    add_project(title="Coffee dispensing website",
